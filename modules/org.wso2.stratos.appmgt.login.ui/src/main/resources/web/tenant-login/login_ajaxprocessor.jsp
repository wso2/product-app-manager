...
<fmt:bundle basename="org.wso2.carbon.i18n.Resources">
	...
	<div id="login-content">
					<div class="main-text">
						The WSO2 App Manager, supporting management of all aspects of an API and its life cycle, delivered as a multi-tenant, elastically scaling, metered platform
					</div>
					<div class="clear"></div>

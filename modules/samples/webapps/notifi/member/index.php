...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
         ...
         <div id="message-panel" class="raw raw-message">
            <div class="col-md-12">
              <div class='raw'>
                  <h4>You've got a new message from <b><span id="message-sender"></span></b>:</h4>
              </div>
              <div class='raw'>
                  <h1 id="message-txt"></h1>
                  <h6 id="message-date"></h6>
              </div>
            </div>
         </div>

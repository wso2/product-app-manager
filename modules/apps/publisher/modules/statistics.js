var getBookmarkStats = function (loggedInUser) {
    ...
    return "SELECT RR.REG_NAME AS asset_id, RS.REG_MEDIA_TYPE AS asset_type,COUNT(RR.REG_NAME) AS no_of_bookmarks " +
...
var getStats = function (loggedInUser, startDate, endDate) {

    var db = new Database("WSO2_CARBON_DB");
    var bookmarkStats = db.query(getBookmarkStats(loggedInUser));
    var hotAssetsStats = db.query(getHotAssetStats(startDate,endDate))

    return {"bookmarkStats": bookmarkStats, "hotAssetsStats":hotAssetsStats};

        ...
        [
           /*
           ...
           
            {
                ...
                url : caramel.context + "/asset/" + data.shortName + ""
            },
            {
                name: "Statistics",
                iconClass: "icon-dashboard",
                additionalClasses : (listPartial == "statistics" ) ? "prominent-link" : null,
                url: caramel.context + "/assets/statistics/" + data.shortName + "/"
            }
        ]
    };
    if(data.artifact){
            ...
            [
               /*
               ...
               
                {
                    ...
                    url : caramel.context + "/asset/operations/view/" + data.shortName + "/" + data.artifact.id + ""
                },
                {
                    name : "Edit",
                    iconClass : "icon-edit",
                ...
                },
                {
                    ...
                    url : caramel.context + "/asset/operations/lifecycle/" + data.shortName + "/" + data.artifact.id + ""
                }
            ]
        };
    }

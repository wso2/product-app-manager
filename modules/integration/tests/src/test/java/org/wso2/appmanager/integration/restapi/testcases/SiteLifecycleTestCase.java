...
public class SiteLifecycleTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public SiteLifecycleTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.appm"}, description = "REST API Implementation test : Site lifecycle handling test case")
    public void testSiteLifecycle() {
        ...
        String dataFileName = "publisher" + File.separator + "SiteLifecycleTestCase.txt";

 ...
 */
public class DeleteWebAppInUnpublishedStateTestCase {
    ...
    public void testUnpublishedWebAppDeleteWithValidUsers(String username, String password, String appId)
            throws Exception {
    ...
    public void testUnpublishedWebAppDeleteWithInValidUsers(String username, String password, String appId)
            throws Exception {
        APPMPublisherRestClient publisherRestClient = new APPMPublisherRestClient(backEndUrl);
        publisherRestClient.login(username, password);
        //delete weapp

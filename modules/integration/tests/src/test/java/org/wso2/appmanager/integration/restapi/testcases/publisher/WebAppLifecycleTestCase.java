...
public class WebAppLifecycleTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public WebAppLifecycleTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.appm"}, description = "REST API Implementation test : webapp lifecycle handling test case")
    public void testWebAppLifecycle() {
        ...
        String dataFileName = "publisher" + File.separator + "WebAppLifecycleTestCase.txt";

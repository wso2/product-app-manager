...
public class WebAppTagsTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public WebAppTagsTestCase(TestUserMode userMode) {
    ...
    public void testWebAppTags() {
        ...
        String dataFileName = "store" + File.separator + "WebAppTagsTestCase.txt";

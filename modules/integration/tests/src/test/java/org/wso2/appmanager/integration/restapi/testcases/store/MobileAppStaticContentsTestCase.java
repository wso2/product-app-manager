...
package org.wso2.appmanager.integration.restapi.testcases.store;
...
public class MobileAppStaticContentsTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public MobileAppStaticContentsTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.appm"}, description = "REST API Implementation test : MobileApp static contents handling test case")
    public void testMobileAppStaticContents() {
        ...
        String dataFileName = "store" + File.separator + "MobileAppStaticContentsTestCase.txt";

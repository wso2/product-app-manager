...
public class BusinessOwnerTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public BusinessOwnerTestCase(TestUserMode userMode) {
    ...
    public void testBusinessOwner() {
        ...
        String dataFileName = "store" + File.separator + "BusinessOwnerTestCase.txt";

...
public class MobileAppTagsTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public MobileAppTagsTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.appm"}, description = "REST API Implementation test : Tags handling test case")
    public void testMobileAppTags() {
        ...
        String dataFileName = "store" + File.separator + "MobileAppTagsTestCase.txt";

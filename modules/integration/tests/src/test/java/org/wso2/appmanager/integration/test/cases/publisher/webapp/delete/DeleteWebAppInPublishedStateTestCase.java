 ...
 */
public class DeleteWebAppInPublishedStateTestCase {
    ...
    public void startUp() throws Exception {
        ...
        //Promote lifecycle state in to "Published" state
        appmPublisherRestClient.login(adminUser.getUserName(), adminUser.getPassword());
        changeLifeCycleStateIntoPublished(creatorDeleteAppTestAppId);
        changeLifeCycleStateIntoPublished(adminDeleteAppTestAppId);
        changeLifeCycleStateIntoPublished(publisherDeleteAppTestAppId);
    }

    @Test(dataProvider = "validUserModeDataProvider", description = TEST_DESCRIPTION)
    public void testPublishedWebAppDeleteWithValidUsers(String username, String password, String appId)
            throws Exception {
    ...
    public void testPublishedWebAppDeleteWithInValidUsers(String username, String password, String appId)
            throws Exception {
        APPMPublisherRestClient publisherRestClient = new APPMPublisherRestClient(backEndUrl);
        publisherRestClient.login(username, password);
        //delete weapp
    ...
    private void changeLifeCycleStateIntoPublished(String appId) throws Exception {

...
public class SiteFavouriteAppTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public SiteFavouriteAppTestCase(TestUserMode userMode) {
    ...
    public void testSiteFavouriteApp() {
        ...
        String dataFileName = "store" + File.separator + "SiteFavouriteAppTestCase.txt";

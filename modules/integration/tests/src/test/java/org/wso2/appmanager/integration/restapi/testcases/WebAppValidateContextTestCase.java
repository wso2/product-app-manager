...
public class WebAppValidateContextTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public WebAppValidateContextTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.appm"}, description = "REST API Implementation test : WebApp Vvalidate context test case")
    public void testWebAppValidateContext() {
        ...
        String dataFileName = "publisher" + File.separator + "WebAppValidateContextTestCase.txt";

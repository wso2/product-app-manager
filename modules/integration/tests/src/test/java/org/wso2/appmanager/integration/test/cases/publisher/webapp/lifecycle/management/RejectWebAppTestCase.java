...
public class RejectWebAppTestCase {

    private static final String TEST_DESCRIPTION = "Verify reject a web app in-review";
    private APPMPublisherRestClient appmPublisherRestClient;
    private String appName = "RejectWebAppTestCase";
    ...
    public void testRejectWebApp() throws Exception {
        // Reject the web app.
        HttpResponse httpResponse = appmPublisherRestClient
                .changeState(uuid, AppmTestConstants.LifeCycleStatus.REJECT);
        ...
        assertEquals(responseData.getString(AppmTestConstants.STATUS), "Success",
                     "Asset could not reject successfully.");

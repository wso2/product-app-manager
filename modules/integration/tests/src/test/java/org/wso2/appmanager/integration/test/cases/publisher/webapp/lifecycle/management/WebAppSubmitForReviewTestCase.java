...
public class WebAppSubmitForReviewTestCase {
    ...
    private String appName = "WebAppSubmitForReviewTestCase";
    ...
    public void testWebAppSubmitForReview() throws Exception {
        HttpResponse httpResponse = appmPublisherRestClient
                                                    .changeState(uuid,
                                                                 AppmTestConstants.LifeCycleStatus
                                                                         .SUBMIT_FOR_REVIEW);

...
public class WebAppDocsTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public WebAppDocsTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.appm"}, description = "REST API Implementation test : WebApp docs handling test case")
    public void testWebAppDocs() {
        ...
        String dataFileName = "store" + File.separator + "WebAppDocsTestCase.txt";

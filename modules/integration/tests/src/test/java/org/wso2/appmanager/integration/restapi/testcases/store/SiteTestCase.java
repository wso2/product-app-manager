...
public class SiteTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public SiteTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.appm"}, description = "REST API Implementation test : Site handling test case")
    public void testSite() {
        ...
        String dataFileName = "store" + File.separator + "SiteTestCase.txt";

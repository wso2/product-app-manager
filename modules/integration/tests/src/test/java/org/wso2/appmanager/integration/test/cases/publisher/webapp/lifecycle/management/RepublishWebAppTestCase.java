...
public class RepublishWebAppTestCase {
    ...
    private String appName = "RepublishWebAppTestCase";
    ...
    public void testRepublishWebApp() throws Exception {
        // Republish the web app.
        HttpResponse httpResponse =
                appmPublisherRestClient.changeState(uuid,
                                                    AppmTestConstants.LifeCycleStatus.RE_PUBLISH);
        ...
        assertEquals(responseData.getString(AppmTestConstants.STATUS), "Success",
                     "Asset has not republished successfully.");

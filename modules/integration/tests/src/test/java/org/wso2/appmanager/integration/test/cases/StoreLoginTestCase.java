...
public class StoreLoginTestCase{
    ...
    private static final Log log = LogFactory.getLog(StoreLoginTestCase.class);
    private APPMStoreRestClient storeRestClient;


    @BeforeClass(alwaysRun = true)
    public void startUp() throws Exception {
        storeRestClient = new APPMStoreRestClient("http://localhost:10363");
    }

    @Test(description = TEST_DESCRIPTION)
    public void testStoreLogin() throws Exception {
        HttpResponse response = storeRestClient.login("admin", "admin");

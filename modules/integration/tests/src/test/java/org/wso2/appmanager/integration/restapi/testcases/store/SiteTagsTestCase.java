...
public class SiteTagsTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public SiteTagsTestCase(TestUserMode userMode) {
    ...
    public void testSiteTags() {
        ...
        String dataFileName = "store" + File.separator + "SiteTagsTestCase.txt";

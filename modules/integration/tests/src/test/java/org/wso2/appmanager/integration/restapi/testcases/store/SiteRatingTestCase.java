...
public class SiteRatingTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public SiteRatingTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.appm"}, description = "REST API Implementation test : Site rating test case")
    public void testSiteRating() {
        ...
        String dataFileName = "store" + File.separator + "SiteRatingTestCase.txt";

...
public class WebAppThrottlingTiersTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public WebAppThrottlingTiersTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.appm"}, description = "REST API Implementation test : WebApp throttlingtiers handling test case")
    public void testWebAppThrottlingTiers() {
        ...
        String dataFileName = "publisher" + File.separator + "WebAppThrottlingTiersTestCase.txt";

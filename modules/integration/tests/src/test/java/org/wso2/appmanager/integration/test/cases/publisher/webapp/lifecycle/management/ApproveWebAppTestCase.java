...
public class ApproveWebAppTestCase {
    ...
    private String appName = "ApproveWebAppTestCase";
    ...
    public void testApproveWebApp() throws Exception {
        // Web app is approved by AppPublisher user.
        HttpResponse approvedHttpResponse =
                appmPublisherRestClient.changeState(uuid, AppmTestConstants.LifeCycleStatus.APPROVE);
        ...
        assertEquals(approvedResponseData.getString(AppmTestConstants.STATUS), "Success",
                     "Asset has not approved successfully.");
    }

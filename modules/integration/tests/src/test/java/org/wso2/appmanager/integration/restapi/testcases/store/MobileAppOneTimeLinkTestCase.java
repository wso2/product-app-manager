...
public class MobileAppOneTimeLinkTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public MobileAppOneTimeLinkTestCase(TestUserMode userMode) {
    ...
    public void testMobileAppOTDL() {
        ...
        String dataFileName = "store" + File.separator + "MobileAppOneTimeLinkTestCase.txt";

...
public class WebAppRatingTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public WebAppRatingTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.appm"}, description = "REST API Implementation test : WebApp rating test case")
    public void testWebAppRating() {
        ...
        String dataFileName = "store" + File.separator + "WebAppRatingTestCase.txt";

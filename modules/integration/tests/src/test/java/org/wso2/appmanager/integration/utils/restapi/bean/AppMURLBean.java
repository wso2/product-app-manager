...
package org.wso2.appmanager.integration.utils.restapi.bean;

import org.wso2.carbon.automation.engine.context.beans.ContextUrls;

/**
 * this class creates basic URLs that needs to be used Do not hard code any web app names in this class, construct them
 * outside make sure you have enabled nonBlockingTransportEnabled="true" in product group instance at automation.xml
 */
public class AppMURLBean {
    ...
    public AppMURLBean(ContextUrls contextUrls) {

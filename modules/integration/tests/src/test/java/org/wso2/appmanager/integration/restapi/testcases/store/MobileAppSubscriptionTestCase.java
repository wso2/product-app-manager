...
public class MobileAppSubscriptionTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;
    private ResourceAdminServiceClient resourceAdminServiceClient;

    @Factory(dataProvider = "userModeDataProvider")
    public MobileAppSubscriptionTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.appm"}, description = "REST API Implementation test : MobileApp subscription handling test case")
    public void testMobileAppSubscription() {
        ...
        String dataFileName = "store" + File.separator + "MobileAppSubscriptionTestCase.txt";

...
public class FavouritePageTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public FavouritePageTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.appm"}, description = "REST API Implementation test : Favourite page handling test case")
    public void testFavouritePage() {
        ...
        String dataFileName = "store" + File.separator + "FavouritePageTestCase.txt";

...
public class MobileAppLifecycleTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public MobileAppLifecycleTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.appm"}, description = "REST API Implementation test : mobileapp lifecycle handling test case")
    public void testMobileAppLifecycle() {
        ...
        String dataFileName = "publisher" + File.separator + "MobileAppLifecycleTestCase.txt";

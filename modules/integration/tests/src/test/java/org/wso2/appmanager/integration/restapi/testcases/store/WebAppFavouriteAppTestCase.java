...
public class WebAppFavouriteAppTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public WebAppFavouriteAppTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.appm"}, description = "REST API Implementation test : Favourite app handling test case")
    public void testWebAppFavouriteApp() {
        ...
        String dataFileName = "store" + File.separator + "WebAppFavouriteAppTestCase.txt";

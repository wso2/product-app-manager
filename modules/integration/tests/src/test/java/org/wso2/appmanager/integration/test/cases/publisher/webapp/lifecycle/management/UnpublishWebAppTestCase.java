...
public class UnpublishWebAppTestCase {
    private static final String TEST_DESCRIPTION = "Verify unpublishing a published web app";
    private APPMPublisherRestClient appmPublisherRestClient;
    private String appName = "UnpublishWebAppTestCase";
    ...
    public void testUnpublishWebApp() throws Exception {
        ...
        assertEquals(responseData.getString(AppmTestConstants.STATUS), "Success",
                     "Asset has not unpublished successfully.");

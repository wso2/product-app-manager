 ...
 */
public class DeleteWebAppInApprovedStateTestCase {
    ...
    public void startUp() throws Exception {
        ...
        //Promote lifecycle state in to "Approved" state
        appmPublisherRestClient.login(adminUser.getUserName(), adminUser.getPassword());
        changeLifeCycleStateIntoApproved(creatorDeleteAppTestAppId);
        changeLifeCycleStateIntoApproved(adminDeleteAppTestAppId);
        changeLifeCycleStateIntoApproved(publisherDeleteAppTestAppId);
    }

    @Test(dataProvider = "validUserModeDataProvider", description = TEST_DESCRIPTION)
    public void testApprovedWebAppDeleteWithValidUsers(String username, String password, String appId)
            throws Exception {
    ...
    public void testApprovedWebAppDeleteWithInValidUsers(String username, String password, String appId)
            throws Exception {
        APPMPublisherRestClient publisherRestClient = new APPMPublisherRestClient(backEndUrl);
        publisherRestClient.login(username, password);
        //delete weapp
    ...
    private void changeLifeCycleStateIntoApproved(String appId) throws Exception {

...
public class RetireWebAppTestCase {
    private static final String TEST_DESCRIPTION = "Verify retire an unpublished web app";
    private APPMPublisherRestClient appmPublisherRestClient;
    private String appName = "RetireWebAppTestCase";
    ...
    public void startUp() throws Exception {
        ...
        // Unpublishing the web app.
        appmPublisherRestClient.changeState(uuid, AppmTestConstants.LifeCycleStatus.UNPUBLISH);
    }

    @Test(description = TEST_DESCRIPTION)
    public void testRetireWebApp() throws Exception {
        // Retire the unpublished web app.
        HttpResponse httpResponse =
                appmPublisherRestClient.changeState(uuid, AppmTestConstants.LifeCycleStatus.RETIRE);
        ...
        assertEquals(responseData.getString(AppmTestConstants.STATUS), "Success",
                     "Asset has not retired successfully.");

...
public class MobileAppCreateNewVersionTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public MobileAppCreateNewVersionTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.appm"}, description = "REST API Implementation test : Mobileapp new version handling test case")
    public void testMobileAppCreateNewVersion() {
        ...
        String dataFileName = "publisher" + File.separator + "MobileAppCreateNewVersionTestCase.txt";

...
public class ChangeStateFromCreateToInReviewTestCase {
    ...
    public void testChangeStateFromCreateToInReviewWithValidUsers(String userName, String password, String uuid)
            throws Exception {
        ...
        HttpResponse httpResponse = publisherRestClient.changeState(uuid, AppmTestConstants.LifeCycleStatus
                .SUBMIT_FOR_REVIEW);
    ...
    public void testChangeStateFromCreateToInReviewWithInValidUsers(String userName, String password, String uuid)
            throws Exception {
        APPMPublisherRestClient publisherRestClient = new APPMPublisherRestClient(backEndUrl);

...
public class XacmlpoliciesTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public XacmlpoliciesTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.appm"}, description = "REST API Implementation test : Xacml policies handling test case")
    public void testXacmlpoliciesTestCase() {
        ...
        String dataFileName = "publisher" + File.separator + "XacmlpoliciesTestCase.txt";

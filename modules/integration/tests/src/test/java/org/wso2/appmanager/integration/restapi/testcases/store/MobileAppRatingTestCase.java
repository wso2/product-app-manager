...
public class MobileAppRatingTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public MobileAppRatingTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.appm"}, description = "REST API Implementation test : Mobile app rating test case")
    public void testMobileAppRating() {
        ...
        String dataFileName = "store" + File.separator + "MobileAppRatingTestCase.txt";

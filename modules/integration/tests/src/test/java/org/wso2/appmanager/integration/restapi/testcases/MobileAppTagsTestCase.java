...
public class MobileAppTagsTestCase extends AppMIntegrationBaseTest {
    ...
    @Test(groups = {"wso2.appm"}, description = "REST API Implementation test : mobileapp tags handling test case")
    public void testMobileAppTags() {
        ...
        String dataFileName = "publisher" + File.separator + "MobileAppTagsTestCase.txt";

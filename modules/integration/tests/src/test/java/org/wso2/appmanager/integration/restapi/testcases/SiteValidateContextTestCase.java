...
public class SiteValidateContextTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public SiteValidateContextTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.appm"}, description = "REST API Implementation test : Site validate context test case")
    public void testSiteValidateContext() {
        ...
        String dataFileName = "publisher" + File.separator + "SiteValidateContextTestCase.txt";

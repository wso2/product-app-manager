...
/**
 * This Test class verifies the ability of appCreator, appPublisher and admin users to delete web apps in 'In Review' state
 */
public class DeleteWebAppInReviewStateTestCase {

    private static final String TEST_DESCRIPTION = "Delete web application in In Review state.";
    private static final String TEST_APP_NAME_SUFFIX = "DeleteWebAppInReviewStateTestCase";
    ...
    public void startUp() throws Exception {
        ...
        admin = appMServer.getSuperTenant().getTenantUser(AppmTestConstants.TestUsers.ADMIN);
        ...
        User admin = appMServer.getSuperTenant().getTenantUser(AppmTestConstants.TestUsers.ADMIN);
        appmPublisherRestClient.login(admin.getUserName(), admin.getPassword());
        changeLifeCycleStateIntoInReview(creatorDeleteAppTestAppId);
        changeLifeCycleStateIntoInReview(adminDeleteAppTestAppId);
        changeLifeCycleStateIntoInReview(publisherDeleteAppTestAppId);
    }

    @Test(dataProvider = "validUserModeDataProvider", description = TEST_DESCRIPTION)
    public void testInReviewWebAppDeleteWithValidUsers(String username, String password, String appId)
            throws Exception {
    ...
    public void testInReviewWebAppDeleteWithInValidUsers(String username, String password, String appId)
            throws Exception {
        APPMPublisherRestClient publisherRestClient = new APPMPublisherRestClient(backEndUrl);
        publisherRestClient.login(username, password);
        //delete weapp
    ...
    private void changeLifeCycleStateIntoInReview(String appId) throws Exception {

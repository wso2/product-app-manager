...
public class JavaPolicyTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public JavaPolicyTestCase(TestUserMode userMode) {
    ...
    public void testJavaPolicy() {
        ...
        String dataFileName = "publisher" + File.separator + "JavaPolicyTestCase.txt";

...
public class ChangeStateFromUnpublishToRecycleTestCase {
    ...
    public void testChangeStateFromUnpublishToRecycleWithValidUsers(String userName, String password, String uuid)
            throws Exception {
        ...
        HttpResponse httpResponse = publisherRestClient.changeState(uuid, AppmTestConstants.LifeCycleStatus.RECYCLE);
    ...
    public void testChangeStateFromUnpublishToRecycleWithInValidUsers(String userName, String password, String uuid)
            throws Exception {
        APPMPublisherRestClient publisherRestClient = new APPMPublisherRestClient(backEndUrl);

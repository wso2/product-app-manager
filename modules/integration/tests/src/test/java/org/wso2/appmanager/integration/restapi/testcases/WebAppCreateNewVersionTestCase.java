...
public class WebAppCreateNewVersionTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public WebAppCreateNewVersionTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.appm"}, description = "REST API Implementation test : WebApp new version handling test case")
    public void testWebAppCreateNewVersion() {
        ...
        String dataFileName = "publisher" + File.separator + "WebAppCreateNewVersionTestCase.txt";

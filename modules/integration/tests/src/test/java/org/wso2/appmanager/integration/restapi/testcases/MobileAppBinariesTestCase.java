...
public class MobileAppBinariesTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public MobileAppBinariesTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.appm"}, description = "REST API Implementation test : mobileapp binary contents handling test case")
    public void testMobileAppBinaries() {
        ...
        String dataFileName = "publisher" + File.separator + "MobileAppBinariesTestCase.txt";

...
public class RoleTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public RoleTestCase(TestUserMode userMode) {
    ...
    public void testRole() {
        ...
        String dataFileName = "store" + File.separator + "RoleTestCase.txt";

...
public class EditWebAppInReviewStatusTestCase {
    private static final String TEST_DESCRIPTION = "Edit web app in in-review status";
    ...
    private void changeLifeCycleStatus() throws Exception {
        appmPublisherRestClient.changeState(webApp.getAppId(), AppmTestConstants.LifeCycleStatus.SUBMIT_FOR_REVIEW);
    }

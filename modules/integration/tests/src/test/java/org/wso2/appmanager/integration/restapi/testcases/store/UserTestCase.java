...
public class UserTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public UserTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.appm"}, description = "REST API Implementation test : User test case")
    public void testUser() {
        ...
        String dataFileName = "store" + File.separator + "UserTestCase.txt";

...
public class SiteCreateNewVersionTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public SiteCreateNewVersionTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.appm"}, description = "REST API Implementation test : Site new version handling test case")
    public void testSiteCreateNewVersion() {
        ...
        String dataFileName = "publisher" + File.separator + "SiteCreateNewVersionTestCase.txt";

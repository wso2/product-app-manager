...
public class WebAppStaticContentsTestCase extends AppMIntegrationBaseTest {
    ServerConfigurationManager serverConfigurationManager;

    @Factory(dataProvider = "userModeDataProvider")
    public WebAppStaticContentsTestCase(TestUserMode userMode) {
    ...
    @Test(groups = {"wso2.appm"}, description = "REST API Implementation test : Webapp static contents handling test case")
    public void testWebAppStaticContents() {
        ...
        String dataFileName = "store" + File.separator + "WebAppStaticContentsTestCase.txt";

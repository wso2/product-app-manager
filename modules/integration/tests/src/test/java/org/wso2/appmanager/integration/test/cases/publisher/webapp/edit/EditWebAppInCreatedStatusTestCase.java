...
public class EditWebAppInCreatedStatusTestCase {
    //login
    // create webapp
    // change lifecycle
    // edit with different users -happy scenario
    //edit with different user

    private static final String TEST_DESCRIPTION = "Edit web app in created status";
    private APPMPublisherRestClient appmPublisherRestClient;
    private String appName = "EditWebAppInCreatedStatusTestCase";

...
/**
 * This Test class verifies the ability of appCreator, appPublisher and admin users to delete web apps in 'Retired' state
 */
public class DeleteWebAppInRetiredStateTestCase {
    ...
    public void startUp() throws Exception {
        ...
        //Promote lifecycle state in to "Retired" state
        appmPublisherRestClient.login(adminUser.getUserName(), adminUser.getPassword());
        changeLifeCycleStateIntoRetired(creatorDeleteAppTestAppId);
        changeLifeCycleStateIntoRetired(adminDeleteAppTestAppId);
        changeLifeCycleStateIntoRetired(publisherDeleteAppTestAppId);
    }

    @Test(dataProvider = "validUserModeDataProvider", description = TEST_DESCRIPTION)
    public void testRetiredWebAppDeleteWithValidUsers(String username, String password, String appId)
            throws Exception {
    ...
    public void testRetiredWebAppDeleteWithInValidUsers(String username, String password, String appId)
            throws Exception {
        APPMPublisherRestClient publisherRestClient = new APPMPublisherRestClient(backEndUrl);
        publisherRestClient.login(username, password);
        //delete weapp
    ...
    private void changeLifeCycleStateIntoRetired(String appId) throws Exception {
        ...
        appmPublisherRestClient.changeState(appId, AppmTestConstants.LifeCycleStatus.RETIRE);
    }

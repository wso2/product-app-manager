 ...
 */
public class DeleteWebAppInDeprecatedStateTestCase {

    private static final String TEST_DESCRIPTION = "Delete web application in Deprecated state.";
    private static final String TEST_APP_NAME_SUFFIX = "DeleteWebAppInDeprecatedStateTestCase";
    ...
    public void startUp() throws Exception {
        ...
        //Promote lifecycle state in to "Deprecated" state
        appmPublisherRestClient.login(adminUser.getUserName(), adminUser.getPassword());
        changeLifeCycleStateIntoDeprecated(creatorDeleteAppTestAppId);
        changeLifeCycleStateIntoDeprecated(adminDeleteAppTestAppId);
        changeLifeCycleStateIntoDeprecated(publisherDeleteAppTestAppId);
    }

    @Test(dataProvider = "validUserModeDataProvider", description = TEST_DESCRIPTION)
    public void testDeprecatedWebAppDeleteWithValidUsers(String username, String password, String appId)
            throws Exception {
    ...
    public void testDeprecatedWebAppDeleteWithInValidUsers(String username, String password, String appId)
            throws Exception {
        APPMPublisherRestClient publisherRestClient = new APPMPublisherRestClient(backEndUrl);
        publisherRestClient.login(username, password);
        //delete weapp
    ...
    private void changeLifeCycleStateIntoDeprecated(String appId) throws Exception {

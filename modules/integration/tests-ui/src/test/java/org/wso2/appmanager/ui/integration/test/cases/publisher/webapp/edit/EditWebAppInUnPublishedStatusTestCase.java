...
public class EditWebAppInUnPublishedStatusTestCase extends AppManagerIntegrationTest {
    private static final String TEST_DESCRIPTION = "Edit web app in un-published status";
    private String appName = "EditWebAppInUnPublishedStatusTestCase";

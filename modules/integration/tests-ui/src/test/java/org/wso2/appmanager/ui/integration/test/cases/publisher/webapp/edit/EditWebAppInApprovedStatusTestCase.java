...
public class EditWebAppInApprovedStatusTestCase extends AppManagerIntegrationTest {
    private static final String TEST_DESCRIPTION = "Edit web app in approve status";
    private String appName = "EditWebAppInApprovedStatusTestCase";
    ...
    private void createWebApp(User appCreator) throws Exception {
        ...
        webAppsListPage = createWebAppPage.createWebApp(new org.wso2.appmanager.ui.integration.test.dto.WebApp(appName, appName, context,

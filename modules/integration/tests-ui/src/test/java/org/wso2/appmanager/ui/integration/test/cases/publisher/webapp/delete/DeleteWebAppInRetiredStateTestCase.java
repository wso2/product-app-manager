...
public class DeleteWebAppInRetiredStateTestCase extends AppManagerIntegrationTest {
    ...
    public void startUp() throws Exception {
        ...
        //Retire web apps in each test scenario
        changeLifeCycleStateIntoRetired(creatorDeleteAppTest, driver);
        changeLifeCycleStateIntoRetired(publisherDeleteAppTest, driver);
        changeLifeCycleStateIntoRetired(adminDeleteAppTest, driver);
        closeDriver(driver);
    }

    @Test(dataProvider = "validUserModeDataProvider", description = TEST_DESCRIPTION)
    public void testRetiredWebAppDeleteWithValidUsers(String username, String password, String appName)
            throws Exception {
        WebDriver driver = BrowserManager.getWebDriver();
        //login to publisher
    ...
    public void testRetiredWebAppDeleteWithInValidUsers(String username, String password, String appName)
            throws Exception {
        WebDriver driver = BrowserManager.getWebDriver();
        //login to publisher
        webAppsListPage = (PublisherWebAppsListPage) login(driver, LoginPage.LoginTo.PUBLISHER, username, password);
    ...
    private void changeLifeCycleStateIntoRetired(String appName, WebDriver driver) throws Exception {
        ...
        //Promote the web app life cycle state into Retired state
        webAppsListPage.changeLifeCycleState(appName, appProvider, appVersion,

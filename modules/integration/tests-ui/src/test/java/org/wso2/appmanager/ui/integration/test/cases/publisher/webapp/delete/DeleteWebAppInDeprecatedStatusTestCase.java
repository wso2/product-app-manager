...
/**
 * This Test class verifies the ability of appCreator, appPublisher and admin users to delete web apps in 'Deprecated' state
 */
public class DeleteWebAppInDeprecatedStatusTestCase extends AppManagerIntegrationTest {
    ...
    public void testDeprecatedWebAppDeleteWithValidUsers(String username, String password, String appName)
            throws Exception {
        WebDriver driver = BrowserManager.getWebDriver();
        //login to publisher
    ...
    public void testDeprecatedWebAppDeleteWithInValidUsers(String username, String password, String appName)
            throws Exception {
        WebDriver driver = BrowserManager.getWebDriver();
        //login to publisher
        webAppsListPage = (PublisherWebAppsListPage) login(driver, LoginPage.LoginTo.PUBLISHER, username, password);
    ...
    private void changeLifeCycleStateIntoDeprecated(String appName, WebDriver driver) throws Exception {

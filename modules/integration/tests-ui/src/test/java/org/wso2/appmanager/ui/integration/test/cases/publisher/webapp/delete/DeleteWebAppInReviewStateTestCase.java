 ...
 */
public class DeleteWebAppInReviewStateTestCase extends AppManagerIntegrationTest{
    ...
    public void startUp() throws Exception {
        ...
        changeLifeCycleStateIntoIn_Review(adminDeleteAppTest, driver);
        closeDriver(driver);

    }

    @Test(dataProvider = "validUserModeDataProvider", description = TEST_DESCRIPTION)
    public void testIn_ReviewWebAppDeleteWithValidUsers(String username, String password, String appName)
            throws Exception {
        WebDriver driver = BrowserManager.getWebDriver();
        //login to publisher
    ...
    public void testIn_ReviewWebAppDeleteWithInValidUsers(String username, String password, String appName)
            throws Exception {
        WebDriver driver = BrowserManager.getWebDriver();
        //login to publisher
        webAppsListPage = (PublisherWebAppsListPage) login(driver, LoginPage.LoginTo.PUBLISHER, username, password);
    ...
    private void changeLifeCycleStateIntoIn_Review(String appName, WebDriver driver) throws Exception {

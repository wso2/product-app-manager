...
public class EditWebAppInPublishedStatusTestCase extends AppManagerIntegrationTest {
    private static final String TEST_DESCRIPTION = "Edit web app in published status";
    private String appName = "EditWebAppInPublishedStatusTestCase";

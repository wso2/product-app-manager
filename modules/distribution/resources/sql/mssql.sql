...
SELECT 'API Throttle Handler','org.wso2.carbon.appmgt.gateway.handlers.throttling.APIThrottleHandler','',3,TRUE,'[{"id":"A"},{"policyKey":"gov:/apimgt/applicationdata/tiers.xml"}]',TRUE

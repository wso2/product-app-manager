...
<fmt:bundle basename="org.wso2.carbon.identity.application.authentication.endpoint.i18n.Resources">
    ...
    <head>
        ...
        <!-- Le styles -->
        <link href="/authenticationendpoint/assets/css/bootstrap3.min.css" rel="stylesheet">
        <%--<link href="/authenticationendpoint/css/localstyles.css" rel="stylesheet">--%>
        <link href="/authenticationendpoint/css/styles-appmgr.css" rel="stylesheet">
        <!--[if lt IE 8]>
    ...
    <div id="footer">
        <div class="container">
            <div class="row row-footer">
                <div class="col-md-6">
                    <span> &copy; 2016 WSO2 Inc. All Rights Reserved.</span>
                </div>

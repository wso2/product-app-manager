...
10. dbscript - This directory contains tha latest script files need to be replaced on $PRODUCT_HOME/dbscripts which includes fixes for REGISTRY-1889 and REGISTRY-1881.
    Please replace these files along with applying the patch.

11. lib - This directory contains the latest libraries need to be replaced on $PRODUCT_HOME/lib. Please replace these files along with applying the patch.